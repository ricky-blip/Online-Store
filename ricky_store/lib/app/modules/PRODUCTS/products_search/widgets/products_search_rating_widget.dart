...
class RatingsWidgetProductSearch extends StatelessWidget {
  //NOTE Constractor
  const RatingsWidgetProductSearch({super.key, required this.starRatings});

  final ProductSearch starRatings;
